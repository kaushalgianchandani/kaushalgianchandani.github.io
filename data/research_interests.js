const researchInterests = [
    {
        icon: ["fas fa-icicles", "fas fa-moon"],
        title: "Oceans on icy moons",
        summary: "Dynamics of oceans under ice shells on Europa and Enceladus.",
        content: `... rendering soon ... `
        ...
        //     <p class="text-sm text-slate-500 italic text-center mt-4">Simulation of heat transport in subsurface oceans.</p>

    },
    {
        icon: "fas fa-water",
        title: "Dynamic controls on surface ocean circulation",
        summary: "Investigating the controls on the westward intensification of wind-driven ocean circulation.",
        content: `... rendering soon ... `
    ...
    {
        icon: ["fas fa-snowflake", "fas fa-basketball-ball", "fas fa-globe-americas"], 
        title: "Snowball Earth modeling",
