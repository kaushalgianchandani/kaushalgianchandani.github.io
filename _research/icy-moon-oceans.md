...
I use [NASA's ROCKE-3D model](https://simplex.giss.nasa.gov/gcm/ROCKE-3D/){:target="_blank" rel="noopener noreferrer"} and high-resolution [*Oceananigans.jl*](https://clima.github.io/OceananigansDocumentation/stable/){:target="_blank" rel="noopener noreferrer"} simulations to study circulation in rapidly rotating oceans heated from below. The high-resolution simulations resolve turbulent structures and their interaction with large-scale currents and overturning circulations.
